...
class _diseasesplashState extends State<diseasesplash> {
  ...
  Future getDiseaseInfo() async{
    ...
    response= await http.put(Uri.parse("/disease"),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text('Detecting cancer cells and giving',textAlign: TextAlign.left,style: GoogleFonts.dosis(color: Color(0xFF2B2B2B),fontSize: 23,),),
